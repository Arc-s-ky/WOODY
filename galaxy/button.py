...
class Button(GameObject):
    def __init__(self, x, y, w, h, text, on_click=lambda x: None, hero=0):
        super().__init__(x, y, w, h)
        self.state = 'normal'
        self.on_click = on_click

        self.text = TextObject(x + hero, y + hero, lambda: text, c.button_text_color, c.font_name, c.font_size)
